...
const AVAILABLE_ITEMS: Item[] = [
  ...
  { id: '2', name: 'Conjunto', price: 14.99, discount: 20 },
  { id: '3', name: 'Collar', price: 12.99, discount: 20 },
  { id: '4', name: 'Pulsera', price: 9.99, discount: 20 },
  { id: '5', name: 'Collar', price: 9.99, discount: 20 },
  { id: '6', name: 'Anillo', price: 9.99, discount: 20 },
  { id: '7', name: 'Pulsera', price: 12.99, discount: 20 },
  { id: '8', name: 'Pulsera', price: 6.99, discount: 20 },
  { id: '9', name: 'Anillo', price: 6.99, discount: 20 },
  { id: '10', name: 'Anillo', price: 4.99, discount: 20 },
  { id: '11', name: 'Pendiente', price: 4.99, discount: 20 },
  { id: '12', name: 'Pendiente', price: 6.99, discount: 20 },
  { id: '13', name: 'Pendiente', price: 9.99, discount: 20 },
  { id: '14', name: 'Collar', price: 25.99, discount: 20 },
  { 
    id: '15',
